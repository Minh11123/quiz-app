...
public class QuizController {
    ...
    @PostMapping("/{level}")
    public ResponseEntity<?> addQuiz(@RequestBody Quiz quiz, @PathVariable Integer level){
        quiz.setLevel(level);
    ...
    public ResponseEntity<?> getQuizByLevel(@PathVariable Integer level){
        return new ResponseEntity<>(quizService.findAllQuizzesByLevel(level),HttpStatus.OK);
    }
    ...
    @GetMapping("/category/active/level/{cateId}/{level}")
    public  ResponseEntity<?> getAllQuizzesActiveOfCategoryLevel(@PathVariable Integer cateId,@PathVariable Integer level){
        return  new ResponseEntity<>(quizService.findAllByCategoryAndActiveAndLevel(cateId, level),HttpStatus.OK);
    }
}
